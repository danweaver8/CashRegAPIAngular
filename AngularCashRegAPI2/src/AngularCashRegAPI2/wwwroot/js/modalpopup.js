angular.module('cashRegisterApp').controller('MainCtrl', function ($scope) {
...
angular.module('cashRegisterApp').directive('modal', function () {
    return {
...
*/
angular.module('cashRegisterApp').directive('phoneInput', function($filter, $browser) {
    return {
        require: 'ngModel',
...
angular.module('cashRegisterApp').filter('tel', function () {
    return function (tel) {
        //console.log(tel);
        if (!tel) { return ''; }
...
angular.module('cashRegisterApp').service('sharedProperties', function() {
